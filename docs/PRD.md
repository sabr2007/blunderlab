...
| Training modes   | Разные способы тренировки вокруг review, goals и drills |
...
| Custom board skins      | Cosmetic roadmap, не submission priority         |
...
* pattern drills from repeated mistakes;
...
### 12.4 Training-mode monetization

Для submission Pro-value строится не вокруг cosmetic skins, а вокруг более сильной тренировочной петли:
...
Cosmetic board themes, piece skins и review card styles остаются roadmap. Они не должны быть главным обещанием Pro, потому что BlunderLab продаёт улучшение мышления, а не оформление доски.
...
* Training Goal continuity into the next game;
* Weekly Weakness + Identity Label;
* training modes as Pro-value;
* Chess for Builders landing;
* Pro page business-demo sync.

Deferred beyond submission:

* multiplayer by link;
* weekly report email;
* shareable review cards;
* custom board skins;
* school/team functional dashboard;
* light theme.
...
Главная опасность — попытаться сделать всё: multiplayer, AI, payment, leaderboard, coach, puzzles, skins, legal, analytics and PWA.
...
Для final submission sprint действует отдельный locked scope: [Submission Final Scope](./plans/submission-final-scope.md).
